...
| `GET` | `/api/images` | Image list lookup |
| `GET` | `/api/missing/amber` | Safe182 missing person list proxy |
| `GET` | `/api/missing/detections` | Missing person detection list lookup |
...
| `houseId` | string | no | Optional vacant house ID |
...
| `candidate_name` | string | no | Detected candidate name |
| `candidate_age_label` | string | no | Estimated age label |
| `candidate_gender` | string | no | Estimated gender |
| `similarity` | number string | no | Similarity percentage |
| `camera_label` | string | no | Camera direction label |
| `location` | string | no | Detection location address |
...
Upstream endpoint: `POST https://www.safe182.go.kr/api/lcm/findChildList.do`

Server-side Safe182 form values:

| Field | Value | Description |
|---|---|---|
| `authKey` | server-defined | API 인증키 |
| `rowSize` | server-defined | 조회 건수 |
| `esntlId` | server-defined | 필수 ID |
| `occrAdres` | server-defined | 발생지역 필터 |
...
| Field | Type | Required | Description |
|---|---:|---|---|
| `houseId` | string | no | Filter by vacant house ID |

Response: array of image entries.
...
## `GET /api/missing/detections`

Response: array of missing person detection entries.

Detection entry fields:
...
| `candidateAgeLabel` | string or null |
| `candidateGender` | string or null |
| `similarity` | number or null |
| `cameraLabel` | string or null |
| `location` | string |
| `createdAt` | string |
